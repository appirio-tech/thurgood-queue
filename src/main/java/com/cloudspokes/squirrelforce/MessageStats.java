...
public class MessageStats {
  ...
  public static synchronized void receivedInMainQ() {
    stats.put(Constants.MAIN_RECEIVER_KEY,
        stats.get(Constants.MAIN_RECEIVER_KEY) + 1);
  }

  public static synchronized void sentInMainQ() {
    stats.put(Constants.MAIN_SENDER_KEY,
        stats.get(Constants.MAIN_SENDER_KEY) + 1);
  }

  public static synchronized void receivedLangQ(String lang) {
    stats.put(Constants.LANG_RECEIVER_KEY_PREFIX + lang,
        stats.get(Constants.LANG_RECEIVER_KEY_PREFIX + lang) + 1);
  }
